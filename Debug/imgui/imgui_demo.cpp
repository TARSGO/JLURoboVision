...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Tabs"))
    {
        ...
        if (ImGui::TreeNode("TabItemButton & Leading/Trailing flags"))
        {
            ...
            if (next_tab_id == 0) // KFStateReset with some default tabs
                for (int i = 0; i < 3; i++)
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Resizable, fixed"))
    {
        ...
        // FIXME-TABLE: Providing a stretch-on-SetInitialArmor would make sense especially for tables which don't have saved settings
        HelpMarker(
